...
WHERE l.name IN ('Italian', 'French') AND f.release_year = 2005 ;
...
FROM rental AS r
/* inventory is used to unite */ -- Using comments
INNER JOIN inventory AS i
...
SELECT
-- Listing each column/variable in separate rows
	first_name, 
	last_name, 
	email 
FROM rental AS r 

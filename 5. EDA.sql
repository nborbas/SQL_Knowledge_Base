...
-- Select the count of industry, subtract from total number of rows, and alias as missing
...
-- DROP TABLE IF EXISTS, CREATE TEMP TABLE ... AS, INSERT INTO, UPDATE, SET
-- ----------------------------------------	
...
WHERE (description ILIKE '%trash%' OR description ILIKE '%garbage%') AND category NOT LIKE '%Trash%' AND category NOT LIKE '%Garbage%'
...
SELECT count(*)
FROM evanston311
WHERE date_created >= '2017-03-13' AND date_created < '2017-03-13'::date + '1 day'::interval;
...
-- Select the current timestamp, and the current timestamp + 5 minutes
...
-- Order by integer value of the day of the week the request was created
...
SELECT
	generate_series(
		'2016-01-01',  -- First bin lower value
		'2018-01-01',  -- Last bin lower value
		'6 months'::interval) AS lower,
-- Create upper bounds of bins
	generate_series(
		'2016-07-01',  -- First bin upper value
